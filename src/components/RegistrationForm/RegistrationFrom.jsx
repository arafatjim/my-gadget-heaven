...
export class RegistrationFrom extends Component {
  render() {
    return (
      <div className="w-full max-w-md p-8 space-y-3 rounded-xl border-2 border-[#979393] shadow-sm shadow-amber-100 mb-8 mt-28 bg-[#2f2f2f] dark:bg-gray-900 mx-auto my-10">
	<Helmet>
								<title>DeltaITClub | Registration</title>
							</Helmet>
	<h2 className="mb-3 text-3xl font-semibold text-center">Login to your account</h2>
	<p className="text-sm text-center text-red-600 dark:text-gray-600">Dont have account?
	...
	<form noValidate="" action="" className="space-y-8">
		...
		<button type="button" className="btn mx-auto w-full text-center px-8 py-3 font-semibold rounded-md dark:bg-violet-600 dark:text-gray-50"><a href="#">Sign in</a></button>
	</form>
</div>
    )
  }
